			...
			<form method="post" action="${ctx}/RecoveryLife/addLifeInfo.do"
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%"
					...
					<tr style="height:20px;">
						...
						<td><input type="checkbox" class="chk_3" style="display:none"
							id="keyword_id_recoveryLife_threeOldRecord" name="threeOldRecord"
							value="1" /><label for="keyword_id_recoveryLife_threeOldRecord"></label>
						</td>
					</tr>
					<tr style="height:20px;">
					...
					<tr style="height:20px;">
						...
						<td><input type="checkbox" class="chk_3" style="display:none"
							id="keyword_id_recoveryLife_oneNewRecord" name="oneNewRecord"
							value="1" /><label for="keyword_id_recoveryLife_oneNewRecord"></label>
						</td>
					</tr>
					<tr style="height:20px;">
