	...
	<div id="keyword_id_areasTypeClassify_divAddFront"
		...
		<form method="post" action="${ctx}/UserInfo/addInfo.do"
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				...
				<tr style="height:20px;">
					<td colspan="2" class=""><span class="div_front_prompt"></span><input
						type="button" class="div_button_meun" value="注销登录"
						onclick="javascript:outLogin();" /> </a>
					</td>
				</tr>
				<tr style="height:20px;" class="tr_height">
				</tr>
